...
public class LargeContainerSugar : MonoBehaviour
{
    public SugarPourController sugarController;  // Referensi ke WastePourController
    ...
    void OnTriggerEnter2D(Collider2D other)
    {
        if (other.CompareTag("Waste")) // Cek apakah objek yang masuk adalah sampah
        {
            ...
            sugarController.OnWasteCollected(other.gameObject);
        }
    }
