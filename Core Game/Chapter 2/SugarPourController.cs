...
public class SugarPourController : MonoBehaviour
{
    ...
    void MissionCompleted()
    {
        ...
        if (gameFlowController.currentStage == GameFlowController2.GameStage.PouringSugar)
        {
            gameFlowController.OnPouringSugarFinished();
        }
    }
}
